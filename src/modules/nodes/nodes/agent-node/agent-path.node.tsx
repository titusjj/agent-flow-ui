...
const caseList = [
    { id: nanoid(), value: "Document Analysis" },
    { id: nanoid(), value: "SCD" },
    { id: nanoid(), value: "SSD" },
    { id: nanoid(), value: "CostCenterMapping" },
    { id: nanoid(), value: "AddressMapping" },
    { id: nanoid(), value: "StringManiplation" },
];

const NODE_TYPE = BuilderNode.AGENT;
